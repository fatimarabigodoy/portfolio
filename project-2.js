// Mobile menu functionality
        ...
        // Headspace Info Toggle
        function toggleHeadspace() {
            const info = document.getElementById('headspace-info');
        ...
        // Process Sketch Toggle
        function toggleProcess() {
            const info = document.getElementById('process-info');
            const button = document.querySelector('.process-section .info-button');
